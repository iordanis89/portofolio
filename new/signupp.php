 ...
 ?>
    ...
    <button  class="navbar-toggler" data-toggle="collapse" data-target="#collapse-target">
     ...
     <div class="collapse navbar-collapse" id="collapse-target">
       <ul id="menu" class="navbar-nav ml-auto">
         ...
         <li class="nav-item">
          <a class="nav-link" href="#">Το παιχνίδι</a>
         </li>
         <li class="nav-item">
         <a class="nav-link" href="#">Κατηγορίες</a>
          </li>
        <li class="nav-item">
  ...
  <p class="text-center">Συμπληρώστε τα στοιχεία για να εγραφείτε</p>
    <div class="form-group">
      <label for="username" class="control-label col-sm-2 text-success">username:</label>
      <div  class="col-sm-10">
      <input type="text" class="form-control is valid" id="username" placeholder="username" name="name">
    </div>
    <div class="form-group">
      <label for="email" class=" control-label col-sm-2 text-danger">email</label>
      <div class="col-sm-10">
      <input type="email" class="form-control is-invalid" id="email" placeholder="email" name="email">
    </div>
    <div class="form-group">
      <label for="inputPassword" class=" control-label col-sm-2 text-danger">Password:</label>
      <div class="col-sm-10">
      <input type="password" class="form-control is-invalid" id="inputPassword" placeholder="password" name="pwd">
    </div>
    <div class="form-group">
      <label for="repeatPassword" class=" control-label col-sm-2 text-danger">Password:</label>
      <div class="col-sm-10">
      <input type="password" class="form-control is-invalid" id="repeatPassword" placeholder="repeat-password" name="confirm_password">
    </div>
    <div class="checkbox">
   ...
   <div class="col-sm-1 col-xs-1">
     ...
     <p>The designsters</p></div>    
       ...
       <div class="col-sm-3 col-6">
         <p>Subscribe</p>
         <input type="text" placeholder="Email address" name="mail" required><input type="image"  alt="Subit">
           </div>
